...
public class XMasDay {
    ...
    public void saveItemsToNBTFile(ArrayList<ItemStack> itemList) {
        ...
        try {
            ...
            // create itemlist
            net.minecraft.server.v1_10_R1.NBTTagList nativeTagList = new net.minecraft.server.v1_10_R1.NBTTagList();
    ...
    public ArrayList<ItemStack> loadItemsFromNBT() {
        ...
        try {
            ...
            net.minecraft.server.v1_10_R1.NBTTagList nativeList = (net.minecraft.server.v1_10_R1.NBTTagList) NBTConverter.toNative(tagList);
            itemList.clear();
            for (int i = 0; i < itemAmount; i++) {
                net.minecraft.server.v1_10_R1.ItemStack nativeStack = net.minecraft.server.v1_10_R1.ItemStack.createStack((net.minecraft.server.v1_10_R1.NBTTagCompound) nativeList.get(i));
                if (nativeStack != null) {
